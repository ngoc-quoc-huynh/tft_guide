...
SELECT results_eq(
  ...
  $$VALUES (37)$$,
  'The full_item_translation table should have exactly 37 items for the language_code de.'
);
...
SELECT results_eq(
  ...
  $$VALUES (37)$$,
  'The full_item_translation table should have exactly 37 items for the language_code en.'
);
