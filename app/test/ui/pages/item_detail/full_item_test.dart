...
Future<void> main() async {
  ...
  when(
    () => localDatabaseApi.loadBaseItemDetail('base-item', LanguageCode.en),
  ).thenAnswer(
  ...
  const itemId = 'full-item';
  when(() => localDatabaseApi.loadFullItemDetail(itemId, LanguageCode.en))
      .thenAnswer(
    (_) async => const FullItemDetail(
      id: itemId,
      name: 'Name',
      description: 'Description',
      hint: 'Hint',
...
final class _TestWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<LanguageCodeValueCubit>.value(
      ...
      child: FullItemDetailPage(id: 'full-item'),
    );
  }
}
